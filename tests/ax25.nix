...
in
{
  ...
  testScript = { nodes, ... }:
    ''
      ...
      node1.execute("socat -d -d tcp-listen:1111 pty,link=/dev/ninotnc,b57600,raw >&2 &")
      node1.execute("socat-mux.sh tcp4-listen:1234,reuseaddr,fork tcp:127.0.0.1:1111 >&2 &")
